  ...
  const stats = [
    {
      ...
      value: summary ? formatBigInt(summary.total_articles_consumed) : "—",
      icon: Newspaper,
    ...
    },
    {
      ...
      value: summary ? formatBigInt(summary.articles_processed_today) : "—",
      icon: CheckCircle,
      subtext: "articles analyzed",
      highlight: Number(summary?.articles_processed_today ?? 0n) > 0,
      badgeText:
        Number(summary?.articles_processed_today ?? 0n) > 0
          ? "ACTIVE"
          : undefined,
    ...
    },
    {
      ...
      value: summary ? formatBigInt(summary.pending_candidates) : "—",
      icon: Clock,
    ...
    <div className="p-5 space-y-5" data-ocid="dashboard.page">
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            QUEUE: {procState ? formatBigInt(procState.articles_in_queue) : "—"}
          </Badge>
          <Badge
            variant="outline"
            className="font-mono text-[9px] px-2 py-0.5 border-border text-muted-foreground"
          >
            PROCESSED:{" "}
            {procState ? formatBigInt(procState.total_articles_processed) : "—"}
          </Badge>
          <Badge
            variant="outline"
            className={cn(
